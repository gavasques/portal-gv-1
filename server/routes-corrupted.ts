  ...
  app.post('/api/ai/generate-listing', requireAuth, async (req, res) => {
    try {
      ...
      const mockListing = {
        ...
        description: "Discover the ultimate " + productInfo.category + " experience with our premium " + productInfo.name + ". Crafted with attention to detail and designed for " + targetAudience + ", this product delivers exceptional value and performance."
      };
